...
public class Creature implements Comparable<Creature> {
	...
	private static final ThreadLocal<String> libPath = ThreadLocal
			.withInitial(() -> "/Users/Napoleon/Documents/GeneticDecryption/lib");
				...
				if (tokenSearcher.searchIndex(indexDir, wordInTokens) != 0) {
					...
					while (k != wordInTokens.length()) {
						...
						for (char[] charTable : correctKeyPairs) {
							if (j == 26 || this.genotype[thesiStoGenotype][0] == charTable[0]
									|| this.genotype[thesiStoGenotype][1] == charTable[1]) {
								flag1 = 1;
								break;
							}
						}
